...
/**
  * Show how could we use Optics to manipulate some Json AST
  */
class JsonExample extends PropSpec with PropertyChecks with Matchers  {
...
//  property("Use index to go into an JsObject or JsArray") {
...
//  property("Use at to add delete fields") {
...
//  property("Use each and filterIndex to modify several fields at a time") {
...
//  }
  ...
  property("Plated instance to rewrite any matching elements") {
    Plated.rewrite[Json] {
      case JsString(s) =>
        val u = s.toUpperCase
